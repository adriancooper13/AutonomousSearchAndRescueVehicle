...
: ${AMENT_CURRENT_PREFIX:="/home/adriancooper/Desktop/SeniorDesign/dev/install/path-planning"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/path-planning/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/path-planning/environment/path.sh"
